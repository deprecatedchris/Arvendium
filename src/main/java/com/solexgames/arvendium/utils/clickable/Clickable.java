package com.solexgames.arvendium.utils.clickable;
...
public class Clickable {
    ...
    public TextComponent add(String msg, String hoverMsg, String clickString) {
        ...
        if (clickString != null) message.setClickEvent(new ClickEvent(net.md_5.bungee.api.chat.ClickEvent.Action.RUN_COMMAND, clickString));
        this.components.add(message);
        return message;
    }
