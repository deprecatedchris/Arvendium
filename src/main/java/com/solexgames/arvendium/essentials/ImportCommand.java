...
public class ImportCommand extends BaseCommand {
    ...
    private void handleImport(CommandArgs command) {
        ...
        this.main.getCoreDatabaseManager().getProfiles().drop();
        this.main.getCoreDatabaseManager().getRanks().drop();

        ArvendiumConfig config = this.main.getRanksFile();
        ...
        new BukkitRunnable() {
            public void run() {
                ...
                ImportCommand.this.main.getJedisPubSub().write(object.toString());
            }
